...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "Funkin' Ex" + psychEngineVersion, 12);
		psychVer.scrollFactor.set();
		psychVer.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(psychVer);
		var fnfVer:FlxText = new FlxText(12, FlxG.height - 24, 0, "Soni's Party Night v1", 12);
				...
				else
				{
					...
					FlxFlicker.flicker(menuItems.members[curSelected], 1, 0.06, false, false, function(flick:FlxFlicker)
					{
						...
						switch (optionShit[curSelected])
						{
							...
							#if ACHIEVEMENTS_ALLOWED
							case 'awards':
								MusicBeatState.switchStateOld(new AchievementsMenuState());
							#end

							case 'credits':
								MusicBeatState.switchState(new CreditsState());
							case 'options':
								MusicBeatState.switchStateOld(new OptionsState());
