...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Soni's Party Night"],
			['Soni Heg',		'modcrediticons/soni',		'Mod Director/Artist/Animator',					 'https://www.youtube.com/channel/UCG3kPVtIQeW7nRvRlRbSklQ',		'0xFF0026FF'],
			['KADIY',		'modcrediticons/kadiy',		'Artist/Animator',					 'https://www.youtube.com/@mrymkadiy',		'0xFFA32D2D'],
			['Nemu',		'modcrediticons/nemu',		'Artist',					 'https://x.com/nemutyaaan',		'8B4BFF'],
			['Omoti',		'modcrediticons/omoti',		'Composer',					 'https://x.com/wdon323',		'0xFFFFFFFF'],
			['Ultone',		'modcrediticons/ultone',		'Composer',					 'https://www.youtube.com/@MirPuffSR',		'0xFF0026FF'],
			['Sirei',		'modcrediticons/sire1',		'Composer',					 'https://www.youtube.com/@fnfmodsirei1249',		'8B4BFF'],
			['Synthesize81',		'modcrediticons/synth',		'Composer/Charter',					 'https://www.youtube.com/@synth_the_hedgehog',		'0xFF26FF3F'],
			['UTDL',		'modcrediticons/utdl',		'Charter',					 'https://www.youtube.com/@UTDLch',		'0xFF00AA11'],
			['Bluebison',		'modcrediticons/soushi',		'(soushimiya) Coder/Composer/Charter',					 'https://www.youtube.com/@confusedbluebision',		'0xFF0026FF'],
			[''],
			['Psych Engine Team'],
