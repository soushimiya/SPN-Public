...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Stage Event', "Just for Stage. ah yeahhhhh~"],
		...
		['Change Default Zoom', "Value 1: New Zoom Value"],
		['Fade Characters', "Value 1: Character Type (bf,dad,gf)\nValue 2: New Alpha"],
		['Change HUD Swing', "Value 1: New Swing Type(1.2 is best)"],
		['Set Character Trail', "Value 1: Character Type (bf,dad,gf)\nValue 2: Use Trail(true/false)"],
		['HUD Alpha Tween', "Value 1: New Alpha\nValue 2: Speed"],
		['Switch Drain', "Value 1: true/false"],
		['Deadcity Light', "Value 1: true/false\nonly works on deadcity lmao"],
		['Lyrics', 'Value 1: Modes(Add, Clear)\nValue 2: Text(ony "Add" Mode)']
